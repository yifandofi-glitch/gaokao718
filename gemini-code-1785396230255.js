...
function renderHome() {
  ...
  pageEl.innerHTML =
    '<div class="hero">' +
      '<div class="h1">JOY背单词</div>' +
      '<div class="sub">每天 50 词 · 学-用-练-忘-再练 快乐高效记忆闭环</div>' +
...
function renderAbout() {
  ...
  pageEl.innerHTML =
    '<div class="h1">ℹ️ 关于 JOY背单词</div>' +
    '<div class="card mt12"><div class="h2">📚 JOY背单词 · 快乐记单词</div>' +
      '<div class="about-li"><span class="ico">📖</span><span>词库精准覆盖核心词汇，按考频排序，切分为 ' + TOTAL_DAYS + ' 天学习计划（每天 50 词）。</span></div>' +
      '<div class="about-li"><span class="ico">🔄</span><span>快乐闭环：背单词 → 今日文章（50 词自然融入短文语境）→ 今日拼写（文章挖空默写）→ 重点复习（艾宾浩斯遗忘曲线调度）。</span></div>' +
